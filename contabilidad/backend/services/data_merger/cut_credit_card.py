...
def cuadrar_tarjeta_corte(df_unido, primer_dia, datos_tarjetas, pagos_tarjeta, df_tarjetas):
    from contabilidad.modules.account import get_variables as get_variablesCuenta
    ...
    df_tarjeta_unido_corregido = get_variablesCuenta.marcar_fijos(df_tarjeta_unido_corregido, pagos_filtrados, "PAGO_TARJETA", incluir_ultimo=True)
