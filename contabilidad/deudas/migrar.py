...
def migrar_deudas_desde_df(df: pd.DataFrame, dry_run: bool = True):
    ...
    from contabilidad.deudas.limpiar import limpiar_base_datos
    ...
    for nombre in deudores_unicos:
        ...
        try:
            ...
            from contabilidad.deudas.lectura import obtener_deudas_por_deudor
    ...
    from contabilidad.deudas.escritura import marcar_deuda_como_pagada
    ...
    try:
        ...
        if len(deudas_pagadas) > 0:
            ...
            from contabilidad.deudas.lectura import obtener_todos_deudores
