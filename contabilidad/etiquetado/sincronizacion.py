...
# Hack para asegurar que podemos importar 'contabilidad' si se corre desde app.py
# Intentamos añadir el directorio raíz del proyecto (dos niveles arriba de este archivo)
...
def cargar_datos_fuente():
    ...
    try:
        # 1. Cargar Cuenta
        df_cuenta = leer_datos_guardados_cuenta()
